    ...
    return (
        <section id='gallery' className='mt-20 bg-[#040F16]'>
            ...
            <div className='max-w-[1300px] pt-20 text-center mx-auto'>
                ...
                <h4 className='text-3xl md:text-4xl lg:text-[56px] text-[#FBECEB] mb-20 mt-4 font-bold
'>INSTAGRAM</h4>
                </div>
                {/* gallery image */}
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4'>
                    {
                        galleryImage.map((image , idx)=><img className='w-[90%] hover:scale-[1.1] transition-all duration-500 overflow-hidden md:w-full mx-auto' key={idx} src={image}></img>)
                    }
                </div>
